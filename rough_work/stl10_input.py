...
def serialize_split(IMAGE_PATH, LABEL_PATH, split):
    ...
    if split == "unlabeled":
        save_images(images, 1, split)
    else:
        labels = read_labels(LABEL_PATH)
        print(labels.shape)
        # save images to disk
        save_images(images, labels, split)
...
if __name__ == "__main__":
    ...
    # serialize train images
    serialize_split(TRAIN_DATA_PATH, TRAIN_LABEL_PATH, "train")

    # serialize test images
    serialize_split(TEST_DATA_PATH, TEST_LABEL_PATH, "test")

    # serialize unlabeled images
    serialize_split(UNLABELED_PATH, TEST_LABEL_PATH, "unlabeled")